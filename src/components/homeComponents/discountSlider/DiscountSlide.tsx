...
const DiscountSlide = (props: {
  ...
  return (
    <div
     ...
     dark:bg-neutral-800 border border-neutral-300 dark:border-none text-neutral-800 dark:text-white relative"
    >
      <span className="absolute pl-24 w-56 h-8 bg-red-500 -right-8 -top-5 rotate-[37deg] flex justify-center items-center gap-1">
        <SaleIcon />
        Sale
      </span>
